...
export async function getChangelogEntry(cwd, release, releases, changesets, changelogFuncs, changelogOpts, { updateInternalDependencies, onlyUpdatePeerDependentsWhenOutOfRange, }) {
    ...
    const dependentReleases = releases.filter((rel) => {
        ...
        return (versionRange &&
            ...
            shouldUpdateDependencyBasedOnConfig(cwd, rel, {
...
export function generateMarkdownForVersionType(type, lines) {
...
//# sourceMappingURL=get-changelog-entry.js.map