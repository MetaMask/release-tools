...
export function getDependencyVersionEdits(packageJson, versionsToUpdate, { cwd, updateInternalDependencies, onlyUpdatePeerDependentsWhenOutOfRange, bumpVersionsWithWorkspaceProtocolOnly, snapshot, }) {
    const pkgJsonEdits = [];
        ...
        if (deps) {
            for (const release of versionsToUpdate) {
                ...
                if (!depCurrentVersion ||
                    ...
                    !shouldUpdateDependencyBasedOnConfig(cwd, release, {
...
//# sourceMappingURL=version-package.js.map