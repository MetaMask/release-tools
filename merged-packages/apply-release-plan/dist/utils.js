...
export function shouldUpdateDependencyBasedOnConfig(cwd, release, { depVersionRange, depType, }, { minReleaseType, onlyUpdatePeerDependentsWhenOutOfRange, }) {
        ...
        switch (depVersionRange) {
            ...
            default: {
                if (!validRange(depVersionRange)) {
                    return (path.posix.normalize(depVersionRange) ===
