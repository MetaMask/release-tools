...
Examples:
  ...
  yarn workspace @metamask/apply-release-plan run since-latest-release
  yarn workspace @metamask/apply-release-plan run since-latest-release diff
  yarn workspace @metamask/apply-release-plan run since-latest-release log -p
  yarn workspace @metamask/apply-release-plan run since-latest-release --include-head -- log -p
