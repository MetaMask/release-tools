...
- Releases are shared among the teams that maintain this repo. That means **if you work on a team that has codeownership over a package, you are free to create a new release yourself.**
...
- The release process is a work in progress. Further improvements to simplify the process are planned. If you encounter any issues, please reach out to this repo's maintainers.
...
6. **Push and submit a pull request.**
   ...
   Release PRs can be approved by codeowners of affected packages, so as long as the above guidelines have been followed, there is no need to reach out to this repo's maintainers for approval.
