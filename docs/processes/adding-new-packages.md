...
4. Add your dependencies.
   ...
   - Remember, if you are adding other monorepo packages as dependents, don't forget to add them to the `references` array in your package's `tsconfig.json`, `tsconfig.build.json`, and `tsconfig.lint.json`.
